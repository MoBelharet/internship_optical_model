...
module pisces_optics
   ...
   type, extends(type_base_model), public :: type_pisces_optics
      ...
      type (type_diagnostic_variable_id)         :: id_pe1, id_pe2, id_pe3, id_etot_ndcy, id_etot, id_Tchl, id_par, id_par_ndcy
...
contains
   ...
   subroutine initialize(self, configunit)
      ...
      call self%register_diagnostic_variable(self%id_par_ndcy, 'par_ndcy', 'W m-2', 'daily mean PAR ', source=source_do_column)
   ...
   subroutine do_column(self, _ARGUMENTS_DO_COLUMN_)
      ...
      integer :: irgb
      real(rk) :: f1, f2, f3, pe1, pe2, pe3, heup, heup_01, etot_ndcy, etot, par, par_ndcy, par0
      ...
      _DOWNWARD_LOOP_BEGIN_
         ...
         par = (1._rk - fr_i + rtrn) * etot !max((1._rk - fr_i + rtrn) * etot , 0._rk)
         par_ndcy = (1._rk - fr_i + rtrn) * etot_ndcy !max((1._rk - fr_i + rtrn) * etot_ndcy , 0._rk)
         ...
         _SET_DIAGNOSTIC_(self%id_par,par) ! Added by Mokrane
         _SET_DIAGNOSTIC_(self%id_par_ndcy,par_ndcy) ! Added by Mokrane
