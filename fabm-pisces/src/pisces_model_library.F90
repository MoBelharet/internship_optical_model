module pisces_model_library
   ...
   use pisces_dust
   use pisces_sediment
   use pisces_migration_vertical_distribution
   use pisces_migration_weight_distribution
   use pisces_migration_move
...
contains
   ...
   subroutine create(self,name,model)
      ...
      select case (name)
         ...
         case ('migration_vertical_distribution'); allocate(type_pisces_migration_vertical_distribution::model)
         case ('migration_weight_distribution'); allocate(type_pisces_migration_weight_distribution::model)
         case ('migration_move');      allocate(type_pisces_migration_move::model)
         ! Add new models here
         case default
